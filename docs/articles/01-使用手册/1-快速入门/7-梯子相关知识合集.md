...
#### 1. 获取代理节点订阅链接
1. 电脑上，打开 V2Plus，单击选择一个可用的节点   ![](../2-配置设置/asserts/Pasted%20image%2020250620164432.png)

2. 直接按下快捷键 ‘ctrl + F’，或者右键单击节点，选择”分享服务器“     

3. 此时屏幕上会显示出用于分享服务器的二维码

![](../2-配置设置/asserts/Pasted%20image%2020250620164629.png)

#### 2. 下载并安装客户端工具

1. 根据你的操作系统选择合适的工具（如 Clash for Windows、Clash Verge、V2rayN、NekoRay、v2rayNG 等）
2. 从本文上方提供的 GitHub 地址下载安装最新版

#### 3\. 导入订阅链接

1. 在客户端界面中找到“订阅”或“配置”入口
2. 扫描电脑屏幕上共享的二维码

#### 4\. 启动代理服务

1. 启用 HTTP / SOCKS5 本地代理（或系统代理）
2.  浏览器/系统就可以自动使用代理访问国外网站

#### 5\. 验证是否成功

1.  打开浏览器访问 [Google](https://www.google.com/) 、 [YouTube](https://www.youtube.com/)
2. 或使用 [ip111.cn](https://ip111.cn/) 查看当前 IP 和地区是否为海外